function EnableMailboxOnpremForUser {
  ...
  Invoke-Command -Session $Session {
      Enable-RemoteMailbox -Identity $using:UserPrincipalName -RemoteRoutingAddress "$($using:Username)@TonbridgeAndMallingBC.mail.onmicrosoft.com"
  } | Out-Null
...
function Test-EnableMailboxOnpremForUser {
